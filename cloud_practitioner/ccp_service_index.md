...
103. GuardDuty: use ML algorithm for threat discovery to protect AWS account, input from CloudTrail, VPC Flow Log, DNS log. Can setup CloudWatch Event rules for notification with Lambda or SNS. GuardDuty is a threat detection service that monitors malicious activity and unauthorized behavior to protect your AWS account.                      
